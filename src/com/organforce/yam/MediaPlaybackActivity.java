    ...
    View.OnTouchListener, View.OnLongClickListener
{
    ...
    public boolean onLongClick(View view) {
        ...
        boolean knownartist =
            (artist != null) && !MusicUtils.UNKNOWN_STRING.equals(artist);

        boolean knownalbum =
            (album != null) && !MusicUtils.UNKNOWN_STRING.equals(album);
        ...
        if (knownartist && view.equals(mArtistName.getParent())) {
            ...
            if ((song == null) || MusicUtils.UNKNOWN_STRING.equals(song)) {
