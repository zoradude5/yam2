        ...
        implements View.OnCreateContextMenuListener, MusicUtils.Defs, ServiceConnection
{
    ...
    private void setTitle() {
        ...
        if (mAlbumId != null) {
            ...
            if (numresults > 0) {
                ...
                if (fancyName == null || fancyName.equals(MusicUtils.UNKNOWN_STRING)) {
    ...
    private boolean isMusic(Cursor c) {
        ...
        if (MusicUtils.UNKNOWN_STRING.equals(album) &&
        		MusicUtils.UNKNOWN_STRING.equals(artist) &&
                title != null &&
    ...
    public boolean onContextItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case PLAY_NEXT: {
            	MusicUtils.playNext(mTrackCursor, mSelectedPosition);
            	return true;
            }
    ...
    void doSearch() {
        ...
        if (MusicUtils.UNKNOWN_STRING.equals(mCurrentArtistNameForAlbum)) {
            query = mCurrentTrackName;
        } else {
            query = mCurrentArtistNameForAlbum + " " + mCurrentTrackName;
            i.putExtra(MediaStore.EXTRA_MEDIA_ARTIST, mCurrentArtistNameForAlbum);
        }
        if (MusicUtils.UNKNOWN_STRING.equals(mCurrentAlbumName)) {
    ...
    static class TrackListAdapter extends SimpleCursorAdapter implements SectionIndexer {
        ...
        public void bindView(View view, Context context, Cursor cursor) {
            ...
            if (name == null || name.equals(MusicUtils.UNKNOWN_STRING)) {
