...
public class MediaPlaybackService extends Service {
    ...
    public static final String PLAYSTATE_CHANGED = "com.organforce.yam.playstatechanged";
    public static final String META_CHANGED = "com.organforce.yam.metachanged";
    public static final String QUEUE_CHANGED = "com.organforce.yam.queuechanged";
    public static final String PLAYBACK_COMPLETE = "com.organforce.yam.playbackcomplete";
    public static final String ASYNC_OPEN_COMPLETE = "com.organforce.yam.asyncopencomplete";

    public static final String SERVICECMD = "com.organforce.yam.musicservicecommand";
    ...
    public static final String TOGGLEPAUSE_ACTION = "com.organforce.yam.musicservicecommand.togglepause";
    public static final String PAUSE_ACTION = "com.organforce.yam.musicservicecommand.pause";
    public static final String PREVIOUS_ACTION = "com.organforce.yam.musicservicecommand.previous";
    public static final String NEXT_ACTION = "com.organforce.yam.musicservicecommand.next";
...
/* more 2.3 stuff
     ...
     * "com.organforce.yam.metachanged"
     * "com.organforce.yam.queuechanged",
     * "com.organforce.yam.playbackcomplete"
     * "com.organforce.yam.playstatechanged"
    ...
    public void play() {/*
        ...
        if (mPlayer.isInitialized()) {
            ...
            status.contentIntent = PendingIntent.getActivity(this, 0,
                    new Intent("com.organforce.yam.PLAYBACK_VIEWER")
    ...
    private void saveBookmarkIfNeeded2() {
        try {/*
            if (isPodcast()) {
                long pos = position();
                long bookmark = getBookmark();
